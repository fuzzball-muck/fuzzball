...
/* from https://wiki.mozilla.org/Security/Server_Side_TLS#Intermediate_compatibility_.28default.29 */
...
/* Flags that new programs will be created with. */
#define NEW_PROGRAM_FLAGS ""

...
#define DEPRECATED_FEATURE \
        "This feature will be removed in the next version of Fuzzball."
/**
...
#define SAY_TOKEN '"'           /**< Say shortcut command token */
#define QUIT_COMMAND "QUIT"     /**< QUIT command */
#define WHO_COMMAND "WHO"       /**< WHO command */

/*
 * These are various special tokens related to parameters instead of
 * being commands themselves.
 */
#define AND_TOKEN '&'           /**< AND token */
#define LOOKUP_TOKEN '*'        /**< Lookup token for matching */
#define NOT_TOKEN '!'           /**< NOT token */
#define NUMBER_TOKEN '#'        /**< Token for dbrefs */
#define OR_TOKEN '|'            /**< OR token */
#define REGISTERED_TOKEN '$'    /**< Registered token */

/* Special delimiters */
#define ARG_DELIMITER '='       /**< Argument delimiter */
#define EXIT_DELIMITER ';'      /**< Exit alias delimiter */

/* The ASCII character number for escape */
#define ESCAPE_CHAR 27          /**< ASCII value for escape character */
...
/**
 * @var compile_options
 *      A string variable that is basically a string delimited list of
...
/**
 * @var force_level
 *      a variable to keep track of the force level.  This is incremented
 *      when a 'force' command is used to avoid recursive forcing.
 */
extern int force_level;

/**
 * @var forked_dump_process_flag
 *      boolean value - if true, we are the dump child process.  This is
...
/**
 * @var input_file
 *      file handle for the input database file
 */
